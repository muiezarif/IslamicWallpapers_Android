...
class ImageDisplayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgData=intent.getIntExtra("imageData",0)
        var drawable= resources.getDrawable(imgData)
        bitmap= (drawable as BitmapDrawable).bitmap
        mVisible = true
        loadImage(imgData,fullscreen_content)
        mVisible = true
        ...
        dummy_button.setOnClickListener {
            ...
            Toast.makeText(this,"Image is beig set as wallpaer.",Toast.LENGTH_SHORT).show()
        }
